  ...
  try
    {
      ...
      // monotone now requires Botan 3.0.0 or newer
      E(linked_botan_version >= BOTAN_VERSION_CODE_FOR(3,0,0), origin::system,
        F("this monotone binary requires Botan 3.0.0 or newer"));
